    ...
    public partial class Init : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_DigitalCollections", x => x.Id);
                });

            migrationBuilder.CreateTable(
                name: "DigitalRarities",
                columns: table => new
                {
                    Id = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    Name = table.Column<string>(type: "nvarchar(100)", maxLength: 100, nullable: false)
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_DigitalRarities", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    DigitalCollectionId = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    DigitalRarityId = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    Description = table.Column<string>(type: "nvarchar(500)", maxLength: 500, nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_DigitalItemInstances", x => x.Id);
                    table.ForeignKey(
            ...
            migrationBuilder.CreateIndex(
                name: "IX_DigitalItemInstances_ItemId",
                table: "DigitalItemInstances",
                column: "ItemId");

            migrationBuilder.CreateIndex(
                name: "IX_DigitalItemInstances_OwnerId",
                table: "DigitalItemInstances",
                column: "OwnerId");

            migrationBuilder.CreateIndex(
                name: "IX_DigitalItems_DigitalCollectionId",
                table: "DigitalItems",
                column: "DigitalCollectionId");

            migrationBuilder.CreateIndex(
                name: "IX_DigitalItems_DigitalRarityId",
                table: "DigitalItems",
